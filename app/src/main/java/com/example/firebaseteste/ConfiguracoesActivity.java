...
import com.example.firebaseteste.helper.Permissao;
...
public class ConfiguracoesActivity extends AppCompatActivity {
    ...
    private ImageButton tirarFoto,carregarImagem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBarConfig = getSupportActionBar();
        actionBarConfig.setTitle("Configurações");
        ...
        tirarFoto = findViewById(R.id.id_tirarFoto);
        carregarImagem = findViewById(R.id.id_carregarImagem);
        circleImageView = findViewById(R.id.id_imagemPadraoView);
